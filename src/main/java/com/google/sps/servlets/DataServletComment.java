...
public class DataServletComment extends HttpServlet {
...
@Override
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    for (Entity entity : results.asIterable()) {
        ...
        Comment comment = new Comment(id, comment_content, timestamp);
  ...
  public String convertToJsonUsingGson(ArrayList<Comment> post_arraylist) {
    Gson gson = new Gson();
